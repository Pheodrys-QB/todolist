...
class _EditTaskPage extends State<EditTaskPage> {
  ...
  void initState() {
    ...
    wasSchedule = widget.task.isScheduled;
    isScheduled = wasSchedule;
    scheduleTime = widget.task.scheduleTime;
    if (wasSchedule) {
      setState(() {
        date =
  ...
  void saveTask() {
    Task task =
        Task(widget.task.id, textController.text, isScheduled, scheduleTime);
    if (wasSchedule) {
      //Cancel notification
      notification?.cancelNotification(task.id);
    }
    ...
    if (isScheduled) {
      ...
      notification?.scheduleNotification(
          ...
          schedultTime: task.scheduleTime);
    }
